...
| `contact_network.py` | Simulated contact graph (200 nodes) with animated spread visualization |
...
### `contact_network.py` — Simulated Epidemic Spread
...
├── contact_network.py     # Contact graph simulation + animated spread
